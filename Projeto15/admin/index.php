...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $arrConfig['url_admin'].'assets/vendors/font-awesome/css/font-awesome.min.css'?>" />
  <link rel="stylesheet" href="<?php echo $arrConfig['url_admin'].'assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css'?>">
...
<body>
  ...
  <!-- page-body-wrapper ends -->
    ...
    <script src="<?php echo($arrConfig['url_admin'].'/assets/vendors/chart.js/Chart.min.js'); ?>"></script>
    <script src="<?php echo($arrConfig['url_admin'].'/assets/vendors/jquery-circle-progress/js/circle-progress.min.js'); ?>"></script>
    <!-- End plugin js for this page -->
    <!-- Custom js for this page -->
    <script src="<?php echo($arrConfig['url_admin'].'/assets/js/dashboard.js'); ?>"></script>
